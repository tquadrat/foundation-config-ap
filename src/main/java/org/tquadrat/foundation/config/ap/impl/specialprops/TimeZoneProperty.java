 ...
 *
 *  @version $Id: TimeZoneProperty.java 943 2021-12-21 01:34:32Z tquadrat $
 *  @extauthor Thomas Thrien - thomas.thrien@tquadrat.org
 *  @UMLGraph.link
 *  @since 0.1.0
 */
@ClassVersion( sourceVersion = "$Id: TimeZoneProperty.java 943 2021-12-21 01:34:32Z tquadrat $" )
...
public final class TimeZoneProperty extends SpecialPropertySpecBase
{
    ...
    private static final CodeBlock composeConstructorFragment( final CodeBuilder codeBuilder, @SuppressWarnings( "UseOfConcreteClass" ) final PropertySpecImpl property )
    {
        final var builder = requireNonNullArgument( codeBuilder, "codeBuilder" ).getComposer()
            ...
            .addStatement( "$1N = $2T.systemDefault()", property.getFieldName(), ZoneId.class );
     ...
     */
    @Override
    public final Optional<BiFunction<CodeBuilder, PropertySpecImpl, CodeBlock>> getConstructorFragmentComposer() { return Optional.of( TimeZoneProperty::composeConstructorFragment );}
     ...
     */
    @Override
    public final TypeName getPropertyType() { return ClassName.from( ZoneId.class ); }
