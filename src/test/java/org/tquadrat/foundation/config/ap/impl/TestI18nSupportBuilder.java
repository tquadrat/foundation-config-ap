...
public class TestI18nSupportBuilder extends CodeGeneratorTestBase
{
    ...
    final void testCodeGeneration6( final boolean flag ) throws Exception
    {
        final var header = format( "%n//----< %2$s >%1$s", "-".repeat( 80 ), "testCodeGeneration6" ).substring( 0, 80 );
        ...
        final var interfacesToImplement = List.of( ClassName.from( ConfigBeanSpec.class ), ClassName.from( Map.class ), ClassName.from( I18nSupport.class ) );
        ...
        createPropertiesForI18NSupport( configuration );
