 ...
 *
 *  @version $Id: PrefSpec.java 947 2021-12-23 21:44:25Z tquadrat $
 *  @extauthor Thomas Thrien - thomas.thrien@tquadrat.org
 *  @UMLGraph.link
 *  @since 0.1.0
 */
@SuppressWarnings( "InterfaceNeverImplemented" )
@ClassVersion( sourceVersion = "$Id: PrefSpec.java 947 2021-12-23 21:44:25Z tquadrat $" )
@API( status = STABLE, since = "0.1.0" )
public interface PrefSpec extends PreferencesBeanSpec
{
        /*---------*\
    ====** Methods **==========================================================
        \*---------*/
