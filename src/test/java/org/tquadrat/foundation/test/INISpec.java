 ...
 *
 *  @version $Id: INISpec.java 947 2021-12-23 21:44:25Z tquadrat $
 *  @extauthor Thomas Thrien - thomas.thrien@tquadrat.org
 *  @UMLGraph.link
 *  @since 0.1.0
 */
@SuppressWarnings( "InterfaceNeverImplemented" )
@ClassVersion( sourceVersion = "$Id: INISpec.java 947 2021-12-23 21:44:25Z tquadrat $" )
@API( status = STABLE, since = "0.1.0" )
public interface INISpec extends INIBeanSpec
{
        /*---------*\
    ====** Methods **==========================================================
        \*---------*/
    ...
    /**
     * Returns the property 'date1Ini'.
     *
     * @return The property.
     */
    public Optional<Instant> getDate1Ini();
    ...
    /**
     * Returns the property 'int1Ini'.
     *
     * @return The property.
     */
    public int getInt1Ini();
    ...
    /**
     * Returns the property 'int2Ini'.
     *
     * @return The property.
     */
    public Integer getInt2Ini();
    ...
    /**
     * Returns the property 'string1Ini'.
     *
     * @return The property.
     */
    public String getString1Ini();
