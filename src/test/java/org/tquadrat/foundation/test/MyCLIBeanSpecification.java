 ...
 *
 *  @version $Id: MyCLIBeanSpecification.java 944 2021-12-21 21:56:24Z tquadrat $
 *  @extauthor Thomas Thrien - thomas.thrien@tquadrat.org
 *  @UMLGraph.link
 *  @since 0.1.0
 */
@SuppressWarnings( "InterfaceNeverImplemented" )
@ClassVersion( sourceVersion = "$Id: MyCLIBeanSpecification.java 944 2021-12-21 21:56:24Z tquadrat $" )
@API( status = STABLE, since = "0.1.0" )
public interface MyCLIBeanSpecification extends I18nSupport, CLIBeanSpec
{
        /*---------*\
    ====** Methods **==========================================================
        \*---------*/
...
//  interface MyCLIBeanSpecification
